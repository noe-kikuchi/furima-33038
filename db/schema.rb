...
ActiveRecord::Schema.define(version: 2021_01_08_052539) do
  ...
  create_table "buy_ships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "feescheduled_delivery_id", null: false
